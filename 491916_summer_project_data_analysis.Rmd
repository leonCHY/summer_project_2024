...
general data cleaning, fusing the outcome data together 
```{r}
...
filtering of the appropriate incidents 
```{r}
...
all_incident<-all_incident %>% left_join(terms,by="term") %>%filter(classification==c("Y")) %>% select(-classification) 
